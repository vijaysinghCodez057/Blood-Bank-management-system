...
<tr><td class="lefttd">Age</td><td><input type="number" name="t2" size="4" name="age" min="18" required="required" pattern="[0-9]{2,2}" title="please enter only  numbers between 2 to 2 for age" /></td></tr>
<tr><td class="lefttd">Mobile No</td><td><input type="tel" name="t3" required="required" pattern="[1-9]{3}[0-9]{3}[0-9]{4}" title="please enter mobile no. in exact 10 digit" /></td></tr>
...
<!-- <?php 
	if ($t5 != ""){
		$sql=mysqli_query("select * from `donarregistration` where email='".$t5."'");
		...
		{
			$sql=mysqli_query("insert into `donarregistration` (`email`) values ('$t5')");
		}
	}
?> -->

<tr><td class="lefttd">Password</td><td><input type="password" name="t6" required="required" pattern="[a-zA-Z0-9]{8,16}" title="please enter only character or numbers between 8 to 16 for password" /></td></tr>
<tr><td class="lefttd">Confirm Password</td><td><input type="password" name="t7" required="required" pattern="[a-zA-Z0-9 ]{8,16}" title="please enter only character or numbers between 8 to 16 for password" /></td></tr>
