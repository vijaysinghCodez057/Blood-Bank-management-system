...
<tr><td class="lefttd" align="center">Gender</td><td><input name="r1" type="radio" value="male" checked="checked">Male<input name="r1" type="radio" value="female">Female</td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" align="center">Age</td><td><input type="number" name="t2" size="4" name="age" min="18" required="required" pattern="[0-9]{2,2}" title="You Are not Eligible" /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" align="center">Mobile No</td><td><input type="tel" name="t3"  required="required" pattern="[1-9]{3}[0-9]{3}[0-9]{4}" title="please enter mobile no. in exact 10 digit" /></td></tr>
 <tr><td>&nbsp;</td></tr>
...
<tr><td class="lefttd" align="center">E-Mail</td><td><input type="email" name="t5" required="required" /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd"  name="t6" align="center">Till Required Date</td><td>
<select name="month">
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();
		$d=$_POST["year"]."/".$_POST["month"]."/".$_POST["day"];
			$s="insert into requestes(name,gender,age,mobile,bgroup,email,reqdate,detail) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $d .  "','" .  $_POST["t6"]  ."')";
